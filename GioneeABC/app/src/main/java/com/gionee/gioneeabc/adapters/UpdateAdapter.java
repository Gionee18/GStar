 ...
 */
public class UpdateAdapter extends RecyclerView.Adapter<UpdateAdapter.CustomViewHolder> {
    ...
    public UpdateAdapter(Context context, final List<ProductBean> productList) {
    ...
    public void displayView(int position) {
        String title = "";
        Intent i = new Intent(context, UpdateDetailActivity.class);
        i.putExtra("product", productList.get(position));
        ((UpdateActivity) context).startActivityForResult(i, 101);
